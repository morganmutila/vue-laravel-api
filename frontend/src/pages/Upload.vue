<template>
  <div>
    <h1 class="text-3xl font-bold py-6">Image Upload</h1>
    <div
      data-hs-file-upload='{
        "url": "/upload",
        "extensions": {
    ...
    >
      <template data-hs-file-upload-preview="">
        ...
        >
            ...
            <div class="flex items-center gap-x-3">
              ...
              <div>
                <p class="text-sm font-medium text-gray-800 dark:text-white">
                  <span
                    class="truncate inline-block max-w-75 align-bottom"
          ...
          <div class="flex items-center gap-x-3 whitespace-nowrap">
            ...
            >
              <div
                class="flex flex-col justify-center rounded-full overflow-hidden bg-blue-600 text-xs text-white text-center whitespace-nowrap transition-all duration-500 hs-file-upload-complete:bg-green-600 dark:bg-blue-500"
                style="width: 0"
      ...
      >
        <div class="text-center">
          ...
          <div
            class="mt-4 flex flex-wrap justify-center text-sm/6 text-gray-600"
          >
            <span class="pe-1 font-medium text-gray-800 dark:text-neutral-200">
              Drop your file here or
            </span>
            <span
              class="bg-white font-semibold text-blue-600 hover:text-blue-700 rounded-lg decoration-2 hover:underline focus-within:outline-hidden focus-within:ring-2 focus-within:ring-blue-600 focus-within:ring-offset-2 dark:bg-neutral-800 dark:text-blue-500 dark:hover:text-blue-600"
              >browse</span
            >
          </div>
      ...
      <div
        class="mt-4 space-y-3 empty:mt-0"
