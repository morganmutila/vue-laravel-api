  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <div
            class="py-2 md:py-0 flex flex-col md:flex-row md:items-center gap-1 md:gap-1.5"
          >
            <div class="grow flex items-center justify-between gap-1 md:gap-2">
              <div
              ...
              <div
                class="flex flex-col md:flex-row md:justify-end md:items-center gap-1 md:gap-1.5"
              >
                <RouterLink
                  :to="{ name: 'Upload' }"
                  :class="[
            ...
            <div class="flex flex-wrap items-center gap-x-2">
              ...
              <RouterLink
                to="/signup"
                class="py-2 px-2.5 inline-flex items-center font-medium text-sm rounded-lg bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:bg-blue-600"
                aria-label="Sign up"
              >
                Sign up
              </RouterLink>
